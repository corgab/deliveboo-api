                        ...
                        @foreach ($dishes as $dish)
                            <div class="col-4 d-flex justify-content-center">
                                <div class="card text-center p-4 mb-4">
                                    <h3>{{ $dish->name }}</h3>
                                    <figure>
                                        <img class="img-dish" src="{{ Vite::asset("resources/img/dishes/$dish->thumb")}}"
                                            alt="Foto Piatto">
                                    </figure>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel{{ $dish->id }}">Eliminazione Piatto
                                                </h1>
        ...
        <div class="row">
            <h1>
                ...
                <a class="dropdown-item btn"
                    href="{{ url('admin/restaurant/create') }}">{{__('Registra il tuo Ristorante')}}</a>
            </h1>
        </div>
    @endif
@endsection